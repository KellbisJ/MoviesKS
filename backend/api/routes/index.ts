...
router.get('/', (req, res) => {
	res.json({
		...
		CategoryMoviePreview: 'http://localhost:8000/api/discover/movie?page=1&with_genres=28',
		CategoryTvPreview: 'http://localhost:8000/api/discover/tv?page=1&with_genres=10759',
