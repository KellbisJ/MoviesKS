                ...
                <div className="flex flex-col gap-4 w-full md:w-2/4">
                  ...
                  : `Duración de episodio aproximadamente: ${mediaDetail?.episode_run_time[0] !== undefined ? `${mediaDetail?.episode_run_time[0]} minutos` : 'minutos'}.`}
							...
							{mediaDetailVideos?.length === 0 ? (
								...
								<button
									className="w-full lg:w-60 lg:max-w-60 bg-fuchsia-700 dark:bg-indigo-700 border-none p-2.5 px-5 text-base cursor-pointer rounded-md transition-all duration-300 ease-in-out hover:shadow-lg hover:scale-105 flex items-center justify-center text-white dark:text-gray-100"
               ...
               <div className="flex w-full md:w-2/4 h-80 lg:h-full rounded-lg items-center mx-auto">
                <CreateMediaImages media={mediaImages} type={mediaType} />
					...
					<div className={'flex gap-6 mb-6 flex-col w-full max-w-96 md:max-w-full md:flex-row mx-auto'}>
						<div className={'flex-grow bg-blue-100 dark:bg-indigo-950 p-4 rounded-lg w-full md:w-[80%]'}>
							<h3>Sinopsis</h3>
