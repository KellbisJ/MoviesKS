...
const NavbarSkeletonHero = () => (
	<div className="flex items-center justify-between container mx-auto px-4 sm:px-6 py-3 bg-gray-100 dark:bg-[#1E1A2F] w-full transition h-14">
...
const NavbarSkeletonForwards = () => {
	...
	return (
		<>
			<div className="flex items-center h-14 md:h-16 px-4 sm:px-6 py-4 justify-between bg-white/80 dark:bg-[#1e1a2fe7] w-full fixed transition z-[1000]">
