...
const PopcornParticlesLoader = () => (
  <div className="flex justify-center items-center min-h-screen">
    <div className="relative mb-48">
      <Popcorn className="w-16 h-16 text-primary dark:text-dark-primary animate-pulse-slow drop-shadow-glow z-10" />

      <div className="absolute inset-0 bg-primary/20 dark:bg-dark-primary/20 rounded-full animate-ping-slow" />
