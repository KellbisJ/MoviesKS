...
const MediaContainer: React.FC<MediaContainerPropsInterface> = ({
  media_,
  type,
  variant,
}) => {
      ...
      {media_.poster_path === null ? (
        ...
        <Link
          ...
          <button
            ...
            className={`absolute top-1 opacity-0 group-hover:opacity-100 right-1 p-2 rounded-full backdrop-blur-sm transition-all z-1 cursor-pointer ${
              isFavorite
